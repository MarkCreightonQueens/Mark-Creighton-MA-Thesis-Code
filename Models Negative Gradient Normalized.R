...
GUM_data <- subset(temp_data, select = GUM_variables)
...
temp_varlist <- names(p_values[!p_values >= 0.10])
temp_varlist <- temp_varlist[!temp_varlist %in% exogenous_variables]
temp_varlist <- append(temp_varlist, exogenous_variables, after = length(temp_varlist))
temp_dataset <- subset(full_data, select = temp_varlist)
...
temp_varlist <- names(p_values[!p_values >= 0.05])
temp_varlist <- temp_varlist[!temp_varlist %in% exogenous_variables]
temp_varlist <- append(temp_varlist, exogenous_variables, after = length(temp_varlist))
temp_dataset <- subset(full_data, select = temp_varlist)
varlist <- temp_varlist
...
temp_varlist <- names(p_values[!p_values >= 0.01])
temp_varlist <- temp_varlist[!temp_varlist %in% exogenous_variables]
temp_varlist <- append(temp_varlist, exogenous_variables, after = length(temp_varlist))
temp_dataset <- subset(full_data, select = temp_varlist)
varlist <- temp_varlist
...
column_names <- c('R2_no_sentiment','adj_R2_no_sentiment','MSE_no_sentiment','MSFE_mean_90_no_sentiment','MSFE_variance_90_no_sentiment',
               'MAFE_mean_90_no_sentiment','MAFE_variance_90_no_sentiment','MSFE_mean_80_no_sentiment','MSFE_variance_80_no_sentiment',
               'MAFE_mean_80_no_sentiment','MAFE_variance_80_no_sentiment',
               'R2_Paragraphs_MNB_0_1','adj_R2_Paragraphs_MNB_0_1','MSE_Paragraphs_MNB_0_1','MSFE_mean_90_Paragraphs_MNB_0_1','MSFE_variance_90_Paragraphs_MNB_0_1',
               'MAFE_mean_90_Paragraphs_MNB_0_1','MAFE_variance_90_Paragraphs_MNB_0_1','MSFE_mean_80_Paragraphs_MNB_0_1','MSFE_variance_80_Paragraphs_MNB_0_1',
               'MAFE_mean_80_Paragraphs_MNB_0_1','MAFE_variance_80_Paragraphs_MNB_0_1',
               'R2_Sentences_MNB_0_1','adj_R2_Sentences_MNB_0_1','MSE_Sentences_MNB_0_1','MSFE_mean_90_Sentences_MNB_0_1','MSFE_variance_90_Sentences_MNB_0_1',
               'MAFE_mean_90_Sentences_MNB_0_1','MAFE_variance_90_Sentences_MNB_0_1','MSFE_mean_80_Sentences_MNB_0_1','MSFE_variance_80_Sentences_MNB_0_1',
               'MAFE_mean_80_Sentences_MNB_0_1','MAFE_variance_80_Sentences_MNB_0_1',
               'R2_Paragraphs_MNB_0_4','adj_R2_Paragraphs_MNB_0_4','MSE_Paragraphs_MNB_0_4','MSFE_mean_90_Paragraphs_MNB_0_4','MSFE_variance_90_Paragraphs_MNB_0_4',
               'MAFE_mean_90_Paragraphs_MNB_0_4','MAFE_variance_90_Paragraphs_MNB_0_4','MSFE_mean_80_Paragraphs_MNB_0_4','MSFE_variance_80_Paragraphs_MNB_0_4',
               'MAFE_mean_80_Paragraphs_MNB_0_4','MAFE_variance_80_Paragraphs_MNB_0_4',
               'R2_Sentences_MNB_0_4','adj_R2_Sentences_MNB_0_4','MSE_Sentences_MNB_0_4','MSFE_mean_90_Sentences_MNB_0_4','MSFE_variance_90_Sentences_MNB_0_4',
               'MAFE_mean_90_Sentences_MNB_0_4','MAFE_variance_90_Sentences_MNB_0_4','MSFE_mean_80_Sentences_MNB_0_4','MSFE_variance_80_Sentences_MNB_0_4',
               'MAFE_mean_80_Sentences_MNB_0_4','MAFE_variance_80_Sentences_MNB_0_4',
               'R2_Paragraphs_LR_0_1','adj_R2_Paragraphs_LR_0_1','MSE_Paragraphs_LR_0_1','MSFE_mean_90_Paragraphs_LR_0_1','MSFE_variance_90_Paragraphs_LR_0_1',
               'MAFE_mean_90_Paragraphs_LR_0_1','MAFE_variance_90_Paragraphs_LR_0_1','MSFE_mean_80_Paragraphs_LR_0_1','MSFE_variance_80_Paragraphs_LR_0_1',
               'MAFE_mean_80_Paragraphs_LR_0_1','MAFE_variance_80_Paragraphs_LR_0_1',
               'R2_Sentences_LR_0_1','adj_R2_Sentences_LR_0_1','MSE_Sentences_LR_0_1','MSFE_mean_90_Sentences_LR_0_1','MSFE_variance_90_Sentences_LR_0_1',
               'MAFE_mean_90_Sentences_LR_0_1','MAFE_variance_90_Sentences_LR_0_1','MSFE_mean_80_Sentences_LR_0_1','MSFE_variance_80_Sentences_LR_0_1',
               'MAFE_mean_80_Sentences_LR_0_1','MAFE_variance_80_Sentences_LR_0_1',
               'R2_Paragraphs_OLR_0_4','adj_R2_Paragraphs_OLR_0_4','MSE_Paragraphs_OLR_0_4','MSFE_mean_90_Paragraphs_OLR_0_4','MSFE_variance_90_Paragraphs_OLR_0_4',
               'MAFE_mean_90_Paragraphs_OLR_0_4','MAFE_variance_90_Paragraphs_OLR_0_4','MSFE_mean_80_Paragraphs_OLR_0_4','MSFE_variance_80_Paragraphs_OLR_0_4',
               'MAFE_mean_80_Paragraphs_OLR_0_4','MAFE_variance_80_Paragraphs_OLR_0_4',
               'R2_Sentences_OLR_0_4','adj_R2_Sentences_OLR_0_4','MSE_Sentences_OLR_0_4','MSFE_mean_90_Sentences_OLR_0_4','MSFE_variance_90_Sentences_OLR_0_4',
               'MAFE_mean_90_Sentences_OLR_0_4','MAFE_variance_90_Sentences_OLR_0_4','MSFE_mean_80_Sentences_OLR_0_4','MSFE_variance_80_Sentences_OLR_0_4',
               'MAFE_mean_80_Sentences_OLR_0_4','MAFE_variance_80_Sentences_OLR_0_4',
               'R2_Paragraphs_BERT_0_1','adj_R2_Paragraphs_BERT_0_1','MSE_Paragraphs_BERT_0_1','MSFE_mean_90_Paragraphs_BERT_0_1','MSFE_variance_90_Paragraphs_BERT_0_1',
               'MAFE_mean_90_Paragraphs_BERT_0_1','MAFE_variance_90_Paragraphs_BERT_0_1','MSFE_mean_80_Paragraphs_BERT_0_1','MSFE_variance_80_Paragraphs_BERT_0_1',
               'MAFE_mean_80_Paragraphs_BERT_0_1','MAFE_variance_80_Paragraphs_BERT_0_1',
               'R2_Sentences_BERT_0_1','adj_R2_Sentences_BERT_0_1','MSE_Sentences_BERT_0_1','MSFE_mean_90_Sentences_BERT_0_1','MSFE_variance_90_Sentences_BERT_0_1',
               'MAFE_mean_90_Sentences_BERT_0_1','MAFE_variance_90_Sentences_BERT_0_1','MSFE_mean_80_Sentences_BERT_0_1','MSFE_variance_80_Sentences_BERT_0_1',
               'MAFE_mean_80_Sentences_BERT_0_1','MAFE_variance_80_Sentences_BERT_0_1',
               'R2_Paragraphs_BERT_0_4','adj_R2_Paragraphs_BERT_0_4','MSE_Paragraphs_BERT_0_4','MSFE_mean_90_Paragraphs_BERT_0_4','MSFE_variance_90_Paragraphs_BERT_0_4',
               'MAFE_mean_90_Paragraphs_BERT_0_4','MAFE_variance_90_Paragraphs_BERT_0_4','MSFE_mean_80_Paragraphs_BERT_0_4','MSFE_variance_80_Paragraphs_BERT_0_4',
               'MAFE_mean_80_Paragraphs_BERT_0_4','MAFE_variance_80_Paragraphs_BERT_0_4',
               'R2_Sentences_BERT_0_4','adj_R2_Sentences_BERT_0_4','MSE_Sentences_BERT_0_4','MSFE_mean_90_Sentences_BERT_0_4','MSFE_variance_90_Sentences_BERT_0_4',
               'MAFE_mean_90_Sentences_BERT_0_4','MAFE_variance_90_Sentences_BERT_0_4','MSFE_mean_80_Sentences_BERT_0_4','MSFE_variance_80_Sentences_BERT_0_4',
               'MAFE_mean_80_Sentences_BERT_0_4','MAFE_variance_80_Sentences_BERT_0_4')

results_aggregated <- data.frame(column_names,results_GUM,results_stepwise_10,results_stepwise_05,results_stepwise_01,results_AIC,results_RF_6, results_RF_10, results_RF_15, results_Bagging, results_SVM_radial)

results_aggregated <- as.data.frame(t(results_aggregated))
colnames(results_aggregated) <- results_aggregated[1,]
results_aggregated <- results_aggregated[-1,]


save(results_aggregated, file = "results_aggregated_negative_gradient.Rda")
